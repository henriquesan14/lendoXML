...
public class Principal {
	public static void main(String[] args) {
		File f=new File("C:/Users/ricog/Desktop/PIBMunicipiosPE.xml"); //Substitua pelo o diretorio que o arquivo está
		...
		for(Element registro: registros){  //for pra iterar os registros
			System.out.println(registro.getAttributeValue("campo1")+" - "+registro.getAttributeValue("campo2"));
		}
